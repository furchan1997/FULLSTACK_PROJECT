...
- **הערה**
- הייתי מנהל את התוכן המחוק והיוזרים שנמחקו בצורה אחרת שתשמור אותם בקולקשיין נפרד ולא מוחקת אותם לגמרי, מחקתי לגמרי כי רציתי להראות שאני יודע לבצע בקשת מחיקה מהשרת, אבל אני מתכוון לשנות את זה בעתיד.
